package com.danacimpoacaqa.variableandcomments;
...
//        Declare the primitive data type variable
        ...
        byte lowerLimit0fByteDateType;
        byte upperLimitOfByteDateType;
 ...
 //
        ...
        lowerLimit0fByteDateType = -128;
        upperLimitOfByteDateType = 127;
        ...
        upperLimitOgLongDataType = 9223372036854775807L;
